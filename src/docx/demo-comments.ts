...
import {
  CommentRangeEnd,
  CommentRangeStart, CommentReference, Document, Packer, PageBreak, PageNumber, Paragraph, TextRun, WidthType,
} from 'docx'
...
Packer.toBuffer(doc).then((buffer) => {
  fs.writeFileSync('./src/docx/demo-comments.docx', buffer)
})
